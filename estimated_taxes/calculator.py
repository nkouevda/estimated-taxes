...
# See https://edd.ca.gov/siteassets/files/pdf_pub_ctr/26methb.pdf
def get_ca_withholding(data):
    ...
    regular_tax = (
        constants.ca.INCOME_TAX_WITHHOLDING[data.year][data.filing_status].get_tax(
            regular_taxable_wages
        )
        - allowance
    )
    supplemental_tax = (
        data.supplemental_wages * constants.ca.WITHHOLDING_SUPPLEMENTAL_RATE[data.year]
    )
    tax = regular_tax + supplemental_tax
...
# See https://www.ftb.ca.gov/forms/2025/2025-540-booklet.html
